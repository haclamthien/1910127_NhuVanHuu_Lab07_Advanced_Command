...
namespace Lab07_Advanced_Command
{
    ...
    {
        private List<Lab07_Advanced_Command.Model.Type> types = new List<Lab07_Advanced_Command.Model.Type>();
        
        public CategoryForm()
        {
            types.Add(new Lab07_Advanced_Command.Model.Type("Đồ ăn", 1));
            types.Add(new Lab07_Advanced_Command.Model.Type("Đồ uống", 0));
            InitializeComponent();
        }
